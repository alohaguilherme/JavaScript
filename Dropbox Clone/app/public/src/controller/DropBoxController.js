class DropBoxController {
    ...
    initializeApp(){
        ...
        var firebaseConfig = {
        apiKey: "AIzaSyBQ1_Ha3FQP-EXIX6XNmnUWFrXdtAJ9Bz8",
        authDomain: "dropboxclone-a4148.firebaseapp.com",
        databaseURL: "https://dropboxclone-a4148.firebaseio.com",
        projectId: "dropboxclone-a4148",
        storageBucket: "dropboxclone-a4148.appspot.com",
        messagingSenderId: "261353951261",
        appId: "1:261353951261:web:b00d02493138b33e"
        };
        // Initialize Firebase
            ...
            if ((i + 1) === this.currentFolder.length){
                ...
                span.innerHTML = `             
                    <span class="ue-effect-container uee-BreadCrumbSegment-link-0">
                            <a href="#"  
                           data-path="${path.join('/')}" class="breadcrumb-segment">${folderName}</a>
                    </span>
